cc.Class({
    ...
    creatJSON:function(){
		...
		var monsterData = [
			...
			{"id":0,"name":"失了智的外星人","hp":40,"hit":1,"def":1,"str":1,"cri":1,"eva":0,"vam":1,"asp":2,"drop":[{"id":0,"odds":0.5,"number":3},{"id":1,"odds":1,"number":1}]},
			{"id":1,"name":"外出卖萌的风滚草","hp":40,"hit":1,"def":1,"str":1,"cri":1,"eva":0,"vam":1,"asp":2,"drop":[{"id":0,"odds":0.5,"number":3},{"id":1,"odds":1,"number":1}]}
		]
	...
	deleteData: function() {
		cc.sys.localStorage.removeItem("buildData");
		cc.sys.localStorage.removeItem("articleData");
		cc.sys.localStorage.removeItem("backPackData");
		cc.sys.localStorage.removeItem("skillData");
		cc.sys.localStorage.removeItem("personnelData");
		cc.sys.localStorage.removeItem("backPackInfo");
		cc.sys.localStorage.removeItem("heroData");
		cc.sys.localStorage.removeItem("monsterData");
		cc.sys.localStorage.removeItem("personnelInfo");
		cc.sys.localStorage.removeItem("massageData");
		cc.sys.localStorage.removeItem("chillDownData");
		cc.sys.localStorage.removeItem("randomEventData");
		
		cc.log('delete complete');
	},
